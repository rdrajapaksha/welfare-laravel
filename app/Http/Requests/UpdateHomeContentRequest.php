...
class UpdateHomeContentRequest extends FormRequest
{
    ...
    {
        return [
            'hero_eyebrow_en' => ['required', 'string', 'max:160'],
            'hero_eyebrow_si' => ['required', 'string', 'max:160'],
            'hero_eyebrow_ta' => ['required', 'string', 'max:160'],
            'hero_title_en' => ['required', 'string', 'max:255'],
            'hero_title_si' => ['required', 'string', 'max:255'],
            'hero_title_ta' => ['required', 'string', 'max:255'],
            'hero_accent_en' => ['required', 'string', 'max:255'],
            'hero_accent_si' => ['required', 'string', 'max:255'],
            'hero_accent_ta' => ['required', 'string', 'max:255'],
